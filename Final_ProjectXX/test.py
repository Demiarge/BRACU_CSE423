...
def drawxo():
    ...
    for i in range(3):
        for j in range(3):
            if matrix[i][j] == 1:
                glColor3f(0.5, 0.0, 0.5)  # Set color to prpl
                # Draw X symbol using midpointline
                x_center = 50 + j * 100
                y_center = 100 + i * 100
                ...
                #glColor3f(a,a,0)
                draw_lines(x1, y1, x2, y2)  # Draw /
                draw_lines(x1, y2, x2, y1)  # Draw \
